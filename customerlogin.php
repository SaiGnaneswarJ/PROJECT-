...
<body>
    ...
    <form action ="customerlogindata.php" name="login" onsubmit="return validateForm()" method="post">
        ...
        <a href="customerform.php">Register Here</a>
...
<script src="customerloginvalid.js"></script>
